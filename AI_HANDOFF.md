# AI Handoff: Insurance LIFF Project Status (V6.1.10: Form Layout Refinement)
...
- **Upload History Session**: เพิ่มฟีเจอร์สำหรับดูประวัติการอัปโหลดตลอดอายุของ Session เพื่อให้ผู้ใช้สามารถติดตามผลลัพธ์ของรายการที่ยื่นส่งไปทั้งหมดได้ โดยสามารถเปิดดูประวัติได้จากปุ่มลอย (Floating Button) ที่มุมซ้ายล่าง
...
- **Duplicate Registration Soft Block (New! V6.1.7)**: ป้องกันการสร้างงาน "เช็คเบี้ยใหม่" สำหรับรถที่มีข้อมูลอยู่แล้วในระบบ โดยเมื่อผู้ใช้พิมพ์ทะเบียนรถ ระบบจะทำ Background Search หากพบข้อมูลตรงกันเป๊ะๆ ระบบจะขึ้นป้ายเตือน ("เคยขอใบเสนอราคาในปีนี้แล้ว! ไม่สามารถสร้างเช็คเบี้ยใหม่ซ้ำได้") และบล็อคปุ่มส่งข้อมูล พร้อมให้ปุ่มสลับเป็นโหมด "ส่งเอกสารเพิ่มเติม" แบบรวดเร็ว
...
---
*Last Updated: 2026-07-19 (V6.1.10: Form Layout Refinement)*
