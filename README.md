...
- **V6.4.0: 100% Master Data String/Slug Primary Keys Standardisation**: มาตรฐานระบบเป็น Semantic String Slug Primary Keys 100% ครอบคลุม Master Data ทั้งหมด (`companyId`, `productId`, `categoryId`, `paymentMethodId`, `brokerChannelId`, `levelId`, `templateId`, `province`, `vehicleMake`, `vehicleModel`) พร้อมระบบเคลียร์ค่าทะเบียนรถ/ชื่อผู้เอาประกัน กรมธรรม์เดิม และข้อมูลรถยนต์อัตโนมัติเมื่อสลับหมวดหมู่ประกันภัย
